...
echo ^<^!-- https://kodi.wiki/view/NFO_files/Music_videos --^>>> "%filepath%.nfo"
...
if exist "%filepath%-*.jpg" echo    ^<^!-- maybe useles as follwowing tags supposed for online lookup not needed seems not needed when local artwork is used --^>>> "%filepath%.nfo"
if exist "%filepath%-*.png" echo    ^<^!-- maybe useles as follwowing tags supposed for online lookup not needed seems not needed when local artwork is used --^>>> "%filepath%.nfo"
